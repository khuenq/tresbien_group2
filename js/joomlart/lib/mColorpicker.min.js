...
(function ($) {
	...
	$.fn.mColorPicker = function (options) {
		...
		if (match = navigator.userAgent.match(/MSIE ([0-9]{1,}[\.0-9]{0,})/) || navigator.userAgent.match(/Trident.*rv:([0-9]{1,}[\.0-9]{0,})/))
			$.fn.mColorPicker.attributeChangedEvent = 'propertychange';
		else if (match = navigator.userAgent.toLowerCase().match(/webkit ([0-9]{1,}[\.0-9]{0,})/))
			$.fn.mColorPicker.attributeChangedEvent = 'DOMSubtreeModified';
		...
		$(document).delegate(".mColorPicker", "keyup", function () {
			try {
		...
		$(document).delegate(".mColorPickerTrigger", "click", function () {
	...
	$.fn.mColorPicker.drawPicker = function () {
		...
		imageFolder = $o.imageFolder + "picker.png";
		$("#mColorPickerImg").css({
			"background-image": "url(" + imageFolder + ")",
			"width": "192px",
			"height": "136px",
			"cursor": "crosshair",
			"border": "0 none",
		});
		$("#mColorPickerSwatches").css({"border-right": "1px solid #000000"});
		$(".mClear").css({"clear": "both"});
	...
	$.fn.mColorPicker.closePicker = function () {
		...
		$(".mColor, .mPastColor, #mColorPickerInput, #mColorPickerWrapper").off();
		$("#mColorPickerBg").hide();
